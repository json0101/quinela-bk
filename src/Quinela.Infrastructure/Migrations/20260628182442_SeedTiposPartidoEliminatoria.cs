...
namespace Quinela.Infrastructure.Migrations
{
    ...
    /// NOTA: NO se inserta "Dieciseisavos" (id 2) porque ya existe en producción; solo se le asigna
    /// a los partidos (si el tipo existe).
    /// </summary>
    public partial class SeedTiposPartidoEliminatoria : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    // Dieciseisavos (id 2) NO se inserta: ya existe en producción.
            ...
            // Dieciseisavos: solo se asigna si el tipo 2 existe (en prod sí; en BD nueva no se inserta).
            migrationBuilder.Sql("UPDATE partidos SET tipo_partido_id = 2 WHERE fase_id = 2 AND id BETWEEN 73 AND 88 AND EXISTS (SELECT 1 FROM tipos_partido WHERE id = 2);");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // No se borra el id 2 (Dieciseisavos): no lo creó esta migración (existe en producción).
            for (var id = 7; id >= 3; id--)
